...
namespace SakuraEDL.Views
{
    public partial class Form1
    {
        ...
        private void LoadMtkChipList()
        {
            ...
            // 添加自动检测选项
            mtkSelectChip.Items.Insert(0, new CompatSelectItem("自动检测") { Tag = (ushort)0 });
        ...
        private void LoadMtkExploitTypes()
        {
            ...
            // 添加漏洞类型选项
            mtkSelectExploitType.Items.Add(new CompatSelectItem("自动") { Tag = "Auto" });
            mtkSelectExploitType.Items.Add(new CompatSelectItem("Carbonara") { Tag = "Carbonara" });
            mtkSelectExploitType.Items.Add(new CompatSelectItem("AllInOne签名") { Tag = "AllinoneSignature" });
            mtkSelectExploitType.Items.Add(new CompatSelectItem("无") { Tag = "None" });
